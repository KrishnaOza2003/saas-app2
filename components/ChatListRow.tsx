...
function ChatListRow({ chatId }: { chatId: string }) {
  ...
  if (!chatId) {
    // Handle the case where chatId is undefined or null.
    // You can return a placeholder, log an error, or handle it based on your use case.
    console.log("\n\n\n" + chatId.length + "\n\n\n");
    
    return <div>Error: Invalid chatId</div>;
  }
